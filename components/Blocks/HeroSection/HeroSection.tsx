	...
	return (
		<div className="  relative">
			...
			<SpecialHeader
				...
				spacial_text="JustLook"
				end_ext="Your One-Stop Destination for MakeUp!  "
				full_text_style=" max-w[880px]  px-7 md:px-14 "
			/>

			{/* Desc */}
			<NormalDescription styles="mt-8 max-w-[700px] px-8 mx-auto text-center">
				At JustLook, we understand the importance of
			...
			<Image
				...
				src={"/img/freestocks-YGmk9UZMdZg-unsplash.jpg"}
				width={1440}
				height={700}
			/>
		</div>
